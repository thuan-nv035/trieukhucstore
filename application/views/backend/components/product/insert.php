					...
					<div class="box" id="view">
						<div class="box-body">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Giá gốc</label>
									<input name="price_root" class="form-control" value="0" min="0" step="1" max="1000000000">
								</div>
								<div class="form-group">
									<label>Giảm giá</label>
									<input name="sale_of" class="form-control" >
								</div>
								<div class="form-group">
									<label>Giá đã giảm</label>
									<input name="price_buy" class="form-control"  value="0" min="0" step="1" max="1000000000">
									<div class="error" id="password_error"><?php echo form_error('price_buy')?></div>
								</div>
								<div class="form-group">
									<label>Số lượng</label>
									<input name="number" class="form-control" value="1" min="1" step="1" max="1000">
								</div>
								<div class="form-group">
                                    <label>Ảnh</label>
