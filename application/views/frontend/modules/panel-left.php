<div class="menu-pri" style="background: #006633;">
    <div class="container">
        <div class="panel-left" style="background: #006633;">
            <!--MOBILE-->
            <nav class="navbar navbar-default hidden-md hidden-lg" role="navigation">
                <div class="container-fluid" style="background-color: #006633;">
                        ...
                        foreach ($listcat as $menu) {
                            ...
                            if(count($submenu))
                            {
                                ...
                                foreach ($submenu as $menu1){
                                    $html_menu.='<li style="background:#006633">';
        ...
        <div class="col-md-12 col-lg-12 panel-right hidden-xs text-center" style="background: #006633;">
