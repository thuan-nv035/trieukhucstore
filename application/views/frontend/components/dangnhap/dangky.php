						...
						<div class="acc_content clearfix" style="display: block;">
							<form accept-charset="UTF-8" action="" id="customer_register" method="post">
								...
								<div class="col_full nobottommargin">
									<button class="button button-3d button-black nomargin" id="register-form-submit" name="register-form-submit" type="submit" style="margin-bottom: 20px; background: #006633;">Đăng ký</button>
									<ul>
										<li class="right" style="font-size: 18px;">Bạn đã có tải khoản?    <a href="<?php echo base_url()?>dang-nhap" style="font-size: 19px; color: #006633; text-decoration: underline;">Đăng nhập ngay</a></li>
									</ul>
								</div>
							</form>
						</div>
